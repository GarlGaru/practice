...
public class ManyToOneAssociationTests {
    ...
    //엔티티 매니저가 관리하지 않는 객체가 되는 것이기 때문에, 세션이 종료 되었다는 에러가 발생한다.
    //지연로딩을 사용하는 경우 동일한 트랜젝션 내에서 사용해야 한다

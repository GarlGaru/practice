...
@Controller
@RequestMapping("/first/*")     //first를 모두 여기서 처리하겠다
...
public class firstController {
    ...
    * */
    ...
    public String registMenu(Model model, WebRequest request) {
        ...
        String message = menuName + "을(를) 신규 메뉴 목록의 " + categoryCode + "번 카테코리에 "
                + menuPrice + "원으로 등록하였습니다!";
    ...
    public String modifyMenuPrice(Model model,
        ...
        System.out.println("modifyMenuPrice = " + modifyPrice);
